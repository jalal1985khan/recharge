                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">Qr Api Gatway setting</a> 
                                                </li>
                                                <li class="breadcrumb-item"><a href="settings.php">QR Code API</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !! Do You Want To Change Your QR Code Api ::</h5>
                                                        <span> <code>Change</code> Your QR Code Api
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container row" >
                                                          <div class="col-sm-6">
                                                        <h4 class="pb-3"> QR Code Api Gatway:: </h4>
                                                        <form method="post" enctype="multipart/form-data">
                                                          ...
                                                          <div class="col-sm-6">
                                                             <?php
                                                             $q = $con->query("SELECT * FROM `qr-code`");
                                                             $row = $q->fetch_assoc();
                                                             ?>
