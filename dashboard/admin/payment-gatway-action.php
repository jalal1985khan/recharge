                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">Edit Gatway</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !! Do You Want To Change Your Edit Gatway::</h5>
                                                        <span> <code>Change</code> Your Edit Gatway
