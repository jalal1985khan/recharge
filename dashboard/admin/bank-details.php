...
if(isset($_POST['submit'])){
    ...
    $bnk  = $_POST['bnk'];
    $ifsc = $_POST['ifsc'];
    if($con->query("UPDATE `bank_details` SET `BANK`='$bnk',`ACCOUNT`='$acc',`IFSC`='$ifsc',`BRANCH`='$branch' WHERE ID='1'")){
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                            <form action=""  method="POST" enctype="multipart/form-data" >
                                                                <?php 
                                                                $row = $con->query("select * from bank_details where ID='1'")->fetch_assoc();
                                        
                                                                ?>
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="bankname"
                                                                                placeholder="Bank Name" value="<?php echo $row['BANK']?>" name="bnk">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <input type="text"  class="form-control" 
                                                                                placeholder="Account Number" value="<?php echo $row['ACCOUNT']?>" name="acc">
                                                                        </div>
                                                                        <div class="form-group">
                                                                                <input type="text" class='form-control'
                                                                                    placeholder="IFSC Code" value="<?php echo $row['IFSC']?>" name="ifsc">
                                                                        </div>
                                                                        <div class="form-group">
                                                                                <input type="text" class='form-control'
                                                                                    placeholder="Branch Name" value="<?php echo $row['BRANCH']?>" name="branch">
                                                                        </div>
