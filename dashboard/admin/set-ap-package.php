...
if(isset($_POST['update_pack'])){
    $pack = $_POST['Package'];
       $q =  $con->query("UPDATE `Api_users` set COMM_PACK='$pack' where ID='$u_id'");
    if($q){
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    $user_id = $_GET['user_id'];
                                                        $res = $con->query("SELECT * FROM `Api_users` WHERE ID='$user_id'");
                                                        $row = $res->fetch_assoc();
                                                        $cm = $row['COMM_PACK'];
                                                       ...
                                                       <div class="container">
                                                        ...
                                                        <form action="" method="post">
                                                            <div class="form-group row  justify-content-center mt-3">
                                                                ...
                                                                $query = "SELECT * FROM commPackage WHERE USERTYPE='apiuser' and OWNER='ADMIN' and OWNER_ID='$ad_id' order by ID asc";
