...
if(isset($_GET['delete'])){
    $id = $_GET['id'];
    if($con->query("DELETE FROM `subcategory` where ID='$id'")){
            echo "<script> alert('OOPS..! Category Deleted')
            location.replace('product-subcategory.php');
            </script>";
    }
}
...
if(isset($_POST['createsubcategory'] )){
    ...
    $query = "INSERT INTO `subcategory`(`CATEGORYID`, `IMAGE`, `SUBCATEGORY`, `DESCRIPTION`)
        	VALUES ('$categoryid', '$img_name','$sname' , '$description') ";
        	
    $run = mysqli_query($con , $query );
   if($run){
       move_uploaded_file($image['tmp_name'] , "../../images/products/SUBCAT/$img_name");
                                    ...
                                    <div class="page-body">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i> Create Subcategory
                                                        </button>
                                                    </div>
                                                            ...
                                                            <div class="table-content">
                                                                <div class="project-table">
                                                                    <table id="custm-tool-ele"
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $res = $con->query("SELECT * FROM subcategory order by ID desc");
                                                                            if($res->num_rows > 0){
                                                                                $i = 1;
                                                                                while($row = $res->fetch_assoc()){
                                                                                    $cat_id = $row['CATEGORYID'];
                                                                                    $cat = $con->query("select * from category where ID='$cat_id'")->fetch_assoc();
                                                                              
                                                                                    echo ('<tr>
                                                                                                <td>'.$i++.'</td>
                                                                                                <td>'.$cat['CNAME'].'</td>
                                                                                                <td>'.$row['SUBCATEGORY'].'</td>
                                                                                                <td><img src="../../images/products/SUBCAT/'.$row['IMAGE'].'" width="70px" class="img-fluid" alt="tbl"></td>
                                                                                    ...
                                                                                    <a onclick="javascript:confirmationDelete($(this));return false;"   href="product-subcategory.php?delete&id='.$row['ID'].'" class="text-muted"
                                                                                        data-toggle="tooltip"
                                                                                        data-placement="top" title=""
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            ...
                                            <div class="md-content">
                                                <h3 class="f-26">Create Subcategory</h3>
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-user"></i></span>
                                                        <input type="text" class="form-control" name="description" placeholder="Shor Description">
                                                    </div>
                                                    
                                                    <div class="text-center">
                                                        <button type="submit" name="createsubcategory" class="btn btn-primary waves-effect m-r-20 f-w-600 d-inline-block save_btn">Create</button>
                                                        <button type="button"
