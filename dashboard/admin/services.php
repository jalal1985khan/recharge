...
require("../includes/config.php");
   ...
   if(isset($_POST['submitservice']))
   {
    ...
    $query_run = mysqli_query($con,$query);
     ...
     if($query_run)
     {
       echo '<script>alert("services is Added")</script>';
     }
                                                ...
                                                if($res->num_rows > 0){
                                                    while($row = $res->fetch_assoc()){
                                                        echo ('<tr>
                                                                    ...
                                                                    <td>'.$row['STATUS'].'</td>
                                                                    <td>
                                                                        <a href="edit-services.php?edit&id='.$row['ID'].'" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                                                        <a  onclick="javascript:confirmationDelete($(this));return false;" href="services.php?delete&id='.$row['ID'].'" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                                                    </td>
