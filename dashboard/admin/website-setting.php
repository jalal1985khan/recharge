...
<?php 
   ...
   if(isset($_POST['websetting']))
   {
    ...
    if(!empty($name)){
                   ...
                   if($img != ""){
                        if(unlink($dest2)){
                            ...
                            $target = $dest.basename($_FILES['image']['name']);
                             $query22 = "UPDATE `websetting` SET `LOGO`= '$name'";
                ...
                //   echo $dest2;
                   if($img != ""){
                        if(unlink($dest2)){
                            ...
                            $dest = "../../images/";
                            $target = $dest.basename($_FILES['bimage']['name']);
                             $query22 = "UPDATE `websetting` SET `LOGO2`= '$name2'";
                             $query_run = mysqli_query($con,$query22);
                              move_uploaded_file($_FILES['bimage']['tmp_name'] , $target);
                        }else{
                              $dest = "../../images/";
                        $target = $dest.basename($_FILES['bimage']['name']);
                         $query22 = "UPDATE `websetting` SET `LOGO2`= '$name2'";
     ...
     $query = "UPDATE `websetting` SET `WEBSITENAME`='$websitename', `SNUMBER`='$snumber',`SEMAIL`='$semail',`WEBURL`='$weburl', `WEBTITLESEO`='$titleseo',`WEBDESCRIPTION`='$webdescription',`WEBKEYWORDS`='$webkeyword',`ADDRESS`='$address',`REGISTRATION`='$registration',`FACEBOOK`='$facebook',`TWITTER`='$twitter',`YOUTUBE`='$youtube',`LINKEDIN`='$linkedin' WHERE `ID` = 1";
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Website setting</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?php echo $row['WEBSITENAME']; ?>" name="websitename" placeholder="websitename">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <label for="">Logo White</label>
                                                                    <input type="file" class="form-control" name="image" placeholder="">
                                                                        <!-- <img src="" alt=""> -->
                                                                    <span class="messages"></span>
                                                                </div>
                                                                <div class="col-sm-4">
                                                                    <label for="">Logo Black</label>
                                                                    <input type="file" class="form-control" name="bimage" placeholder="">
                                                                        <!-- <img src="" alt=""> -->
                                                                    <span class="messages"></span>
                                                                </div>
                                                                 <div class="col-sm-4">
