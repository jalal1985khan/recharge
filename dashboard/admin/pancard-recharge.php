                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Pan Bill</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-header-text">Pan Bill</h5>
                                                             </div>
                                                                                    ...
                                                                                    <div class="col-lg-12">
                                                                                        <form action="" method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">                                                                                                 <input type='hidden' id="op_code"> <!--for r-offer -->
                                                                                                      ...
                                                                                                      <select onchange="operator_change()" id="operator_menu" name="operator" class="form-control">                                                                                                        <option value="">---- Select Operator ----</option>
                                                                                                        <?php 
                                                                                                        $query = $con->query("select * from operatorManager where SERVICE='PANCARD'");
