...
require("../includes/config.php");
   ...
   if(isset($_POST['submit']))
   {
    ...
    $id = $_POST['id'];
    $query = "UPDATE `retailer` SET `FNAME`='$name',`MOBILE`='$mobile',`EMAIL`='$email',`SMSBAL`='$sms',`DMRBAL`='$dmr',
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Edit retailer</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <div>
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Name" value="<?php echo $row['FNAME'] ?>" name="name">
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-user"></i></span>
