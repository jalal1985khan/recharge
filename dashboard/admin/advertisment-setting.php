...
if(isset($_POST['update'])){
    $txt = $_POST['text'];
    if($con->query("update websetting set advertise='$txt' where ID='1'")){
...
<head>
    <title>Advertisment Setting</title>
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Advertisment Setting</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group">
                                                       <?php
                                                        ...
                                                        <textarea rows="5" name="text" class="form-control col-12 col-md-12 col-sm-12">
                                                            <?php echo $row['advertise']?>
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
