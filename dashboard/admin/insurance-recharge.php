                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-header-text">Insurance</h5>
                                                             </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-lg-12">
                                                                                        <form action="" method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                    <select name="operator" class="form-control">
                                                                                                        ...
                                                                                                        <?php 
                                                                                                        $query = $con->query("select * from operatorManager where SERVICE='INSURANCE'");
                                                                                            ...
                                                                                            <button type="submit" name="submit_rech" class="btn btn-primary waves-effect waves-light m-r-20">Insurance</button>
