...
header("location:login.php");
  ...
  require("../includes/config.php");
   ...
   if(isset($_POST['tractingidupdate']))
   {
     $trackid = $_POST['trackid'];

    $query = "UPDATE `websetting` SET `GOOGLEANALYTICS`='$trackid' WHERE ID = 1";
 ...
 $query_run = mysqli_query($con,$query);
     ...
     if($query_run)
     {
       echo '<script>alert("Tracking id Updated")</script>';
     }
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Google Analytics</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form  action="#" method="post">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" name="trackid"
                                                        id="name" placeholder="Tracking ID" value="<?php echo $row['GOOGLEANALYTICS']; ?>">
                                            ...
                                            <div class="row text-center">
                                                <div class="col-sm-12">
                                                    <button type="submit" name="tractingidupdate" class="btn btn-primary m-b-0">Update</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
