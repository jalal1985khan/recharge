                                        ...
                                        <div class="card-block">
                                            <form method="post" action="" >
                                                <?php  
                                                          ...
                                                          $query = "SELECT * FROM `r-offer` WHERE ID= '$id'";
                                                          $run = mysqli_query($con , $query);
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-sm-4">
                                                     ...
                                                     <div class="col-sm-8">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo $row['APIURL'] ?>" name="balurl" placeholder="http://google.com/pagename?username=xxxxx&password=xxxxx">
                                                        <span class="messages"></span>
                                                    </div>
