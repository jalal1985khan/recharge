...
<body>
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-header-text">DTH</h5>
                                                             </div>
                                                                                            ...
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                      <select onchange="operator_change()" id="operator_menu" name="operator" class="form-control">
                                                                                                        ...
                                                                                                        <?php 
                                                                                                        $query = $con->query("select * from switchOperator where SERVICETYPE='DTH'");
                                                                                                        while($row= $query->fetch_assoc()){
                                                                                                            echo ' <option value="'.$row['LONGCODE'].'">'.$row['PRODUCTNAME'].'</option>';
                                                                                                        }
                                                                                                        ?>
                                                                                                    </select>
                                                                                                </div>
                                                                                                <div class="col-sm-6">
                                                                                                    <input type="text" name="mobile_num" id="number" class="form-control"
    ...
    function get_offer(){
        var dth_code = document.getElementById("op_code").value;
        ...
        if(dth_code == ""){
            ...
            alert("Please enter suitable Number")
                    ...
                    document.getElementById("roff").innerHTML = "loading";  
            $.ajax({
                url:'../masterdistributer/offer-handler/mobile_recharge.php',
                type:'post',
                data:{dth_code:dth_code, number:number},
