...
include("../includes/config.php");
  ...
  {
      $id = $_GET['id'];
       $query = "DELETE FROM `web_contact` WHERE ID = '$id'";
        $query_run = mysqli_query($con,$query);
        echo "<script> alert('Deleted')
        location.replace('website-contact.php');
        </script>
        ";
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">All Contact Report</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-block">
                                                ...
                                                <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $q = $con->query("SELECT * FROM web_contact where (DATE BETWEEN '$date1' AND '$date2')  order by ID DESC");
                                                            $i =1 ;
                                                            ...
                                                            <tr>
                                                              ...
                                                              <td><a onclick="javascript: confirmationDelete($(this));return false;" href="website-contact.php?delete&id=<?php echo $row['ID'] ?>" 
                                                              class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
                                                                  <i class="icofont icofont-delete-alt"></i></a></td>
                                                            </tr>
                                                         <?php } }else{
                                                             $date = date("Y-m-d");
                                                            $q = $con->query("SELECT * FROM web_contact where DATE='$date' order by ID ASC");
                                                            $i =1 ;
                                                            while($row = $q->fetch_assoc()){
                                                         ?>
                                                              <tr>
