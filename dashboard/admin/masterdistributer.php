...
if(isset($_GET['status'])){
    ...
    if($con->query("update masterdistributer SET STATUS='$status' where ID='$id'")){
        ...
        location.replace('masterdistributer.php');
        </script>";
    }
                                     ...
                                     <div class="card">
                                                    ...
                                                    while($row = $res->fetch_assoc()){
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><a target="_blank" href="set-package.php?user_id=<?php echo $row['ID']?>" class="text-center text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a></td>
                                                                    <td><a href="masterdistributer.php?id=<?php echo $row['ID'] ?>&status=<?php echo $row['STATUS']?>" ><?php echo ($row['STATUS'] == "Activate") ? "Activate" : "Deactivate" ?></a></td>
                                                                     <td>
                                                                        <a target="_blank" href="edit-masterdistributer.php?id=<?php echo $row['ID'] ?>" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                                                        <a onclick="javascript: confirmationDelete($(this));return false;" href="masterdistributer.php?delete&id=<?php echo $row['ID']?>" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <?php
                                                                  }
                                        ...
                                        <div class="md-modal md-effect-13 addcontact" id="modal-13">
                                            ...
                                            <div class="md-content">
                                                <h3 class="f-26">Add Master Distributer</h3>
                                                <div>
