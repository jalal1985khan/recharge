...
require("../includes/config.php");
   ...
   if(isset($_POST['submit']))
   {
    ...
    $id = $_POST['id'];
    $query = "UPDATE `distributer` SET `NAME`='$name',`MOBILE`='$mobile',`EMAIL`='$email',`SMSBAL`='$sms',`DMRBAL`='$dmr',
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Edit distributer</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                          <form action="" method="post">
                                              <?php
                                              $id = $_GET['id'];
                                              $row = $con->query("select * from distributer where ID='$id'")->fetch_assoc();
