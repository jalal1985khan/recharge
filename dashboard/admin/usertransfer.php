                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">User Management</a> 
                                                </li>
                                                <li class="breadcrumb-item"><a href="settings.php">User Transfer</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !! Do You Want To Transfer Account</h5>
                                                        <span> <code>Transfer</code> Account Transfer
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        <h4 class="pb-3"> Account Transfer : </h4>
                                                        <form method="post">
                                                            <div class="form-group row mt-3">
                                                                <div class="input-group col-sm-6">
                                                                    <select id="hello-single" name="rt" class="form-control stock">
                                                                ...
                                                                <div class="input-group col-sm-6">
                                                                    <select id="hello-single" name="ms" onChange="getSubcat(this.value);" class="form-control stock">
                                                            ...
                                                            <div class="form-group row mt-3">
                                                                <div class="input-group col-sm-6">
                                                                    <select id="product" name="ds" class="form-control stock">
