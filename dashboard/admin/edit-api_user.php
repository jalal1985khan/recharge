...
require("../includes/config.php");
   ...
   if(isset($_POST['submit']))
   {
    ...
    $id = $_POST['id'];
    $query = "UPDATE `Api_users` SET `NAME`='$name',`MOBILE`='$mobile',`EMAIL`='$email',`SMSBAL`='$sms',`DMRBAL`='$dmr',
                                                ...
                                                <div>
                                                   <div class="input-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input type="text" class="form-control" value="<?php echo $row['SMSBAL'] ?>" name="smsbal">
                                                        <span class="messages"></span>
                                                    </div>
                                                     <div class="col-sm-4">
                                                        <label for="">RC BALANCE</label>
                                                        <input type="text" class="form-control" value="<?php echo $row['RCBAL'] ?>" name="rcbal" placeholder="http://google.com/pagename?username=xxxxx&password=xxxxx">
                                                        <span class="messages"></span>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label for="">DMR BALANCE</label>
                                                        <input type="text" class="form-control" value="<?php echo $row['DMRBAL'] ?>" name="dmrbal" placeholder="http://google.com/pagename?username=xxxxx&password=xxxxx">
                                                        <span class="messages"></span>
                                                    </div>
                                                </div>
                                                    <div class="input-group">
