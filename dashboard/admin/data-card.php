...
if(isset($_POST['submit_rech'])){
    ...
    if($amount=='' || $mobile=='' || strlen($mobile)!==10 || $amount < 10){
         ...
         $ms_id = $_SESSION["status"];
         $q = $con->query("SELECT * FROM admin where ID='$ms_id'")->fetch_assoc();
         ...
         $q2 = $con->query("SELECT * FROM operator_comm where PACKAGE_ID='$ms_comm' and OP_NAME='$op_name'")->fetch_assoc();
            ...
            $am2 = $amount-$am;
            $am3 = $ms_rcbal - $am2;
            $q4 = $con->query("UPDATE admin set RCBAL='$am3' where ID='$ms_id'");
            if($q4){
                $con->query("INSERT INTO `comm_rpt`(`TYPE`, `USER_ID`, `PERCENT`, `AMOUNT`) VALUES('ADMIN','$ms_id','$prcent','$am') ");
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-header-text">Mobile</h5>
                                                             </div>
