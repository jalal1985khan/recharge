                                    ...
                                    while($row = $res->fetch_assoc()){
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a target="_blank" href="set-rt-package.php?user_id=<?php echo $row['ID'] ?> " class="text-center text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a></td>
                                                    ...
                                                    <td>
                                                        <a target="_blank" href="edit-retailer.php?id=<?php echo $row['ID'] ?>" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                            ...
                                            <div class="md-content">
                                                ...
                                                <div>
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Name" name="f_name">
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-user"></i></span>
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><i
                                                                class="icofont icofont-user"></i></span>
                                                        <input type="number" class="form-control" placeholder="Cuttoff Amount" name="camount">
                                                    </div>
