   ...
   if(isset($_GET['delete']))
  {
      $id = $_GET['id'];
       $query = "DELETE FROM `margin-api` WHERE ID = '$id'";
        ...
        location.replace('api-margin-setting.php');
        </script>
        ";
        }
     }
...
<head>
    <title>API Margin Setting</title>
                                            ...
                                            <div class="card-header">
                                                ...
                                                <button type="button"
                                                            ...
                                                            data-modal="modal-13"> <i
                                                                class="icofont icofont-plus m-r-5"></i> Add API Margin
                                                </button>
                                            </div>
                                                ...
                                                $res = $con->query("SELECT * FROM `margin-api` order by ID asc");
                                                    while($row = $res->fetch_assoc()){
                                                        echo ('<tr>
                                                                    <td>'.$row['ID'].'</td>
                                                                    <td>'.$row['API'].'</td> 
                                                                    <td><a href="api-margin-op.php?api='.$row['API'].'" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a></td>
                                                                    <td> <a onclick="javascript: confirmationDelete($(this));return false;" href="api-margin-setting.php?delete&id='.$row['ID'].'" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
</td>
                                                ...
                                                <div class="md-content">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-center">
                                                            <button type="submit" name="addmarginserviceapi"  class="btn btn-primary waves-effect m-r-20 f-w-600 d-inline-block save_btn">Add</button>
                                                            <button type="button"
