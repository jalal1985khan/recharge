...
if(isset($_POST['submitservice'])){
    ...
    $user = $_POST['usertype'];
    $id = $_POST['id'];
    $q = $con->query("update `commPackage` set USERTYPE='$user' , PACKNAME='$name' where ID='$id'");
                                                ...
                                                <form  method="post" action="" >
                                                    ...
                                                    <div class="input-group">
                                                        <select name="usertype" class="form-control">
                                                            ...
                                                            <option <?php echo ($row['USERTYPE'] == "whitelable") ? "selected" : "" ?>  value="whitelable">WhiteLabel</option>
                                                            <option <?php echo ($row['USERTYPE'] == "masterdistributer") ? "selected" : "" ?>  value="masterdistributer">Master Distributer</option>
