...
if(isset($_POST['submitservice'])){
    ...
    $st = $_POST['status'];
    $id = $_POST['id'];
    $q = $con->query("update `news_alert` set TYPE='$nm' , ALERT='$alert' , STATUS='$st' where ID='$id'");
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <?php
                                                      ...
                                                      {
                                                          $id = $_GET['id'];
                                                          $query = "SELECT * FROM `news_alert` WHERE ID= '$id'";
...
<option <?php echo ($row['TYPE'] == "") ? "selected" : "" ?> value="whiletelabel">White Label</option>
<option value="MASTERDISTRIBUTER" <?php echo ($row['TYPE'] == "MASTERDISTRIBUTER") ? "selected" : "" ?> >Master Distributer</option>
<option  value="DISTRIBUTER" <?php echo ($row['TYPE'] == "DISTRIBUTER") ? "selected" : "" ?> >Distributer</option>
<option   value="RETAILER" <?php echo ($row['TYPE'] == "RETAILER") ? "selected" : "" ?>>Retailer</option>
<option  value="WEBSITE" <?php echo ($row['TYPE'] == "WEBSITE") ? "selected" : "" ?> >Website</option>
<option  value="APIUSER" <?php echo ($row['TYPE'] == "APIUSER") ? "selected" : "" ?>  >API User</option>
                                                            </select>
                                                        </div> 
                                                        <div class="col-sm-6">
                                                            <label for="">Alert</label>
                                                        <input type="text" class="form-control" name="alert" value="<?php echo $row['ALERT'] ?>">
                                                    ...
                                                    <div class="form-group row justify-content-center">
                                                        <div class="col-sm-4">
                                                            <div class="">
                                                                ...
                                                                <label>
                                                                    <input type="radio" name="status" <?php echo ($row['STATUS'] == "Deactivate") ? "checked" : "" ?>  value="Deactivate">
