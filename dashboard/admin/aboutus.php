...
if(isset($_POST['submit'])){
    ...
    if($con->query("UPDATE `apk_about` SET `EMAIL`='$email',`MOB`='$mob',`CUST`='$cust',`WEB`='$web',`ADDRESS`='$add' WHERE ID='1'")){
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">CRM</a> 
                                                </li>
                                                <li class="breadcrumb-item"><a href="settings.php">About Us</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !! Do You Want To Change And Update Your About US</h5>
                                                        <span> <code>Change And Update </code> Your About
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        ...
                                                        <form method="post">
                                                             <?php 
                                                                $row = $con->query("select * from apk_about where ID='1'")->fetch_assoc();
                                                            ...
                                                            <div class="form-group row mt-3">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="text" name="cus_num" value="<?php echo $row['CUST'] ?>"  class="form-control"
                                                                        placeholder="">
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <label for="">Whatsapp Number</label>
                                                                    <input type="text" name="mob_num" value="<?php echo $row['MOB'] ?>" class="form-control"
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mt-3">
                                                            ...
                                                            <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light m-r-20"><i class="ti-cloud-up f-16 m-l-5"></i>Update</button>
                                                            <!--<a href="#!" id="edit-cancel" class="btn btn-danger waves-effect"><i class="icofont icofont-close-circled f-16 m-l-5"></i>Delete</a>-->
                                                        </div>
