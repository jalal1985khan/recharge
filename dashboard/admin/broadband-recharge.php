                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">Brodband</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="page-body">
                                            ...
                                            <div class="card">
                                                            <div class="card-header">
                                                                <h5 class="card-header-text">Brodband</h5>
                                                             </div>
                                                                                        ...
                                                                                        <form action="" method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                <div class="input-group col-sm-6">
                                                                                                      ...
                                                                                                      <select onchange="operator_change()" id="operator_menu" name="operator" class="form-control">                                                                                                        <option value="">---- Select Operator ----</option>
                                                                                                        <?php 
                                                                                                        $query = $con->query("select * from operatorManager where SERVICE='BRODBAND'");
                                                                                                ...
                                                                                                <div class="col-sm-6">
                                                                                                    <input type="text" name="dth_num" class="form-control"
                                                                                            ...
                                                                                            <button type="submit" name="submit_rech" class="btn btn-primary waves-effect waves-light m-r-20">Brodband</button>
