...
?>
 ...
 <?php
  ...
  require("../includes/config.php");
   ...
   if(isset($_POST['updatesms']))
   {
     ...
     echo "<script>alert('called $sms');</script>";
 ...
 $query_run = mysqli_query($con,$query);
     ...
     if($query_run)
     {
       echo '<script>alert("SMS Balance Updated")</script>';
       
     }
 
     else
     {
       echo '<script>alert("Failed to Update SMS Balance")</script>';
     }
    $SMSBAL=0;
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !!  Self SMS Balance</h5>
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        <h4 class="pb-3"> SMS Add Fund : </h4>
                                                        
                                                        <form action="" method="post">
                                                           <div class="form-group row mt-3">
                                                            <div class="col-sm-12">
                                                                    <input type="number" class="form-control" placeholder="Amount" name="sms">
                                                                </div>
                                                            </div>
