...
require("../includes/config.php");
   ...
   if(isset($_POST['addpackage']))
   {
    ...
    $query = "INSERT INTO `commPackage`(`OWNER` , `OWNER_ID` ,`USERTYPE`, `PACKNAME`, `COMM` , `STATUS`) VALUES ('ADMIN' , '$ad_id' , '$usertype' , '$packname' , '0' , '$status') ";
   ...
   if($run) {
                ...
                while($all_op = $operator->fetch_assoc()){
                    ...
                    $pack = $con->query("select * from commPackage where  OWNER='ADMIN' and OWNER_ID='$ad_id' and PACKNAME='$packname'")->fetch_assoc();
                    $pack_id  = $pack['ID'];
  ...
  if(isset($_GET['delete']))
  {
      $id = $_GET['id'];
       ...
       $query = "DELETE FROM `commPackage` WHERE ID = '$id'";
        ...
        if($query_run){
            $con->query("DELETE FROM `operator_comm` where PACKAGE_ID='$id'");
                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                           ...
                                                           <?php
                                                         $ad_id = $_SESSION["status"];
                                                            $res = $con->query("SELECT * FROM commPackage  where OWNER='ADMIN' and OWNER_ID='$ad_id' order by ID asc");
                                                            if($res->num_rows > 0){
                                                ...
                                                <div>
                                                    ...
                                                    <div class="input-group">
                                                        <select name="usertype" class="form-control">
                                                            ...
                                                            <option value="whitelable">WhiteLabel</option>
