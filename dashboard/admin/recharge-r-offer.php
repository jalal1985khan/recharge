                                                ...
                                                $res = $con->query("SELECT * FROM `r-offer` order by ID asc");
                                                    while($row = $res->fetch_assoc()){
                                                        echo ('<tr>
                                                                    ...
                                                                    <td>'.$row['STATUS'].'</td>
                                                                     <td>
                                                                        <a target="_blank" href="edit-recharge-roffer.php?id='.$row['ID'].'" class="m-r-15 text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="icofont icofont-ui-edit"></i></a>
                                                                        <a onclick="javascript:confirmationDelete($(this));return false;" href="recharge-r-offer.php?delete&id='.$row['ID'].'" class="text-muted" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><i class="icofont icofont-delete-alt"></i></a>
                                                                    </td>
