...
?>
 ...
 <?php
  ...
  require("../includes/config.php");
   ...
   if(isset($_POST['updaterc']))
   {
     ...
     echo "<script>alert('called $rc');</script>";
 ...
 $query_run = mysqli_query($con,$query);
     ...
     if($query_run)
     {
       echo '<script>alert("RC Balance Updated")</script>';
       
     }
 
     else
     {
       echo '<script>alert("Failed to Update RC Balance")</script>';
     }
    $RCBAL=0;
                                                       ...
                                                       <div class="container">
                                                        ...
                                                        <form action="" method="post">
                                                           <div class="form-group row mt-3">
                                                            <div class="col-sm-12">
                                                                    <input type="text" class="form-control" placeholder="Amount" name="rc">
                                                                </div>
                                                            </div>
