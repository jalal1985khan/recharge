...
if(isset($_POST['submit'])){
    $link = $_POST['link'];
    if($con->query("update android_store SET LINK='$link' where ID='1'")){
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">Android Store</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !!  Android Path</h5>
                                                        <span> <code>path</code> url link of App From PlayStore</span>
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        <h4 class="pb-3"> Android Path : </h4>
                                                        <form method="post">
                                                            <?php
                                                            $row = $con->query('select * from android_store where ID=1')->fetch_assoc();
                                                            ?>
                                                           <div class="form-group row mt-3">
                                                            <div class="col-sm-12">
                                                                    <input type="text" name="link" value="<?php echo $row['LINK']?>" class="form-control"
                                                                        placeholder="Url Link From PlayStore">
                                                                </div>
                                                            </div>
                                                            <div class="text-center">
                                                            <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light m-r-20"><i class="ti-cloud-up"></i>Update Link</button>
