                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="#!">User commission</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                                    ...
                                                    <table id="custm-tool-ele"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <th>Commission in %</th>
                                                                <th><input type="text" class="comm-input"> %</th>
                                                            </tr>
                                                            <?php
                                                ...
                                                if($res->num_rows > 0){
                                                    while($row = $res->fetch_assoc()){
                                                        echo ('<tr>
                                                                    ...
                                                                    <td>'.$row['SERVICE'].'</td>
                                                                    <td><input type="text" class="comm-input"> %</td>
                                                ...
                                                <div>
                                                    <div class="input-group">
                                                        <select id="hello-single" class="form-control stock">
                                                            ...
                                                            <option value="married">php</option>
                                                            <option value="unmarried">Payraza</option>
                                                            <option value="unmarried">Name</option>
                                                        </select>
                                                    </div>
