...
?>
 ...
 <?php
  ...
  require("../includes/config.php");
   ...
   if(isset($_POST['updatedmr']))
   {
     ...
     echo "<script>alert('called $dmr');</script>";
 ...
 $query_run = mysqli_query($con,$query);
     ...
     if($query_run)
     {
       echo '<script>alert("DMR Balance Updated")</script>';
     }
 
     else
     {
       echo '<script>alert("Failed to Update DMR Balance")</script>';
     }
                                    ...
                                    <div class="page-header">
                                        ...
                                        <div class="page-header-breadcrumb">
                                            <ul class="breadcrumb-title">
                                                ...
                                                <li class="breadcrumb-item"><a href="settings.php">Update DMR Fund</a> 
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Make Sure !!  Udate DMR Fund</h5>
                                                        <span> <code>Update DMR </code> Fund</span>
                                                      ...
                                                      <div class="card-block">
                                                       <div class="container">
                                                        <h4 class="pb-3"> Update DMR Fund : </h4>
                                                        
                                                        <form action="" method="post">
                                                           <div class="form-group row mt-3">
                                                            <div class="col-sm-12">
                                                                    <input type="number" class="form-control" placeholder="Amount" name="dmr">
                                                                </div>
                                                            </div>
