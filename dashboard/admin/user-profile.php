...
if(isset($_POST['update'])){
    ...
    $dest = "img/".$img_name;
    if($otp_val == $_SESSION['otp']){
        if($con->query("UPDATE admin SET NAME='$name' where ID='$id'")){
            echo "<script>alert('Updated')</script>";
            if(!empty($img_name) && $img_name != ""){
                $user = $con->query("select * from admin where ID='$id'")->fetch_assoc();
                $old_img = $user['IMAGE'];
                ...
                if($old_img != "" && $old_img != "default.jpeg" && $default_img != $old_dest){
                        ...
                        $con->query("UPDATE admin SET IMAGE='$img_name' where ID='$id'");
                            ...
                            <div class="main-body user-profile">
                                <div class="page-wrapper">
                                    ...
                                    <div class="page-body">
                                            ...
                                            include("../includes/config.php");
                                            $id = $_SESSION["status"];
                                            $row = $con->query("select * from admin where ID='$id'")->fetch_assoc();
                                            ?>
                                                                                        ...
                                                                                        <table class="table m-0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <th scope="row">Full
                                                                                                        Name</th>
                                                                                                    <td><?php echo $row['NAME']; ?> <?php echo $row['LNAME'] ?>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <th scope="row">
                                                                        ...
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="general-info">
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <input
                                                                                                                type="text"
                                                                                                                class="form-control" name=" mobile" value="<?php echo $row['MOBILE'] ?>"
                                                                                                ...
                                                                                                <tr>
                                                                                                  ...
                                                                                                  <tr>
                                                                                                    ...
                                                                                                    <td id="otp_input" style="display:none;">
                                                                                                        <label>Enter OTP</label>
                                                                                                        <div class="input-group">
                                                                                                            <span
                                                                                                                class="input-group-addon"><i
                                                                                                                    class="icofont icofont-user"></i></span>
                                                                                                            <input class="form-control" id="otp" name="otp_val" required placeholder="">
                                                                                                        </div>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                ...
                                                                                <div class="text-center">
                                                                                    <button onclick="sendotp()" id="otp_btn" class="btn btn-primary waves-effect waves-light m-r-20">Send OTP</button>
                                                                                    
                                                                                    <button style="opacity:0;" id="save_btn" type="submit" name="update"
...
<script>
        function sendotp(){
                var sendotp = "sendotop";
                $("#otp_input").css("display", "block");
            $.ajax({
                url:"handler/edit-profile.php",
                type:'post',
