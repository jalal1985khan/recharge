                                                    ...
                                                    <table id="custm-tool-ele"
                                                       ...
                                                       <thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $q = $con->query("SELECT * FROM recharge_history where (STATUS='Success' OR STATUS=' Sucess ') and (DATE BETWEEN '$date1' AND '$date2')  order by ID ASC");
                                                            $i =1 ;
                                                         ...
                                                         <?php } }else{
                                                             $date = date("Y-m-d");
                                                            $q = $con->query("SELECT * FROM recharge_history where (STATUS='Success' OR STATUS=' Sucess ') and DATE='$date' order by ID ASC");
                                                            $i =1 ;
                                                            while($row = $q->fetch_assoc()){
                                                                $total_am += $row['AMOUNT'];
                                                         ?>
