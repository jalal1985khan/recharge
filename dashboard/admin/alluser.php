                                    ...
                                    while($row = $res->fetch_assoc()){
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href="user_api.php?user_type=RETAILER&user_id=<?php echo $row['ID']?> ">Edit Api</a></td> <td><a  href="../retailer/index.php?login_rt&id=<?php echo $row['ID']?>" target="_blank">Login</a></td>
