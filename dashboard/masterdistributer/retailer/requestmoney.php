                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane" id="binfo" role="tabpanel">
                                                        ...
                                                        // echo $rand;
                                                        require("../includes/pay/constants.php");
                                                                                        ...
                                                                                        <form name="razorpay_frm_payment" class="razorpay-frm-payment" id="razorpay-frm-payment" method="post">
                                                                                            <div class="form-group row mt-3">
                                                                                                ...
                                                                                                <div class="col-sm-12">
                                                                                                    ...
                                                                                                    <input type="hidden" name="surl" id="surl" value="../includes/pay/success.php?user_id=<?php echo $my_id ?>&user_type=RETAILER&token=<?php  echo $rand ?>">
                                                                                                    <input type="hidden" name="furl" id="furl" value="../includes/pay/failed.php">
