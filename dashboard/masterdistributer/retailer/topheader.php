...
session_start();
if(!isset($_SESSION['rt_id']) || $_SESSION['rt_id'] == ""){
...
$retailer_row =$con->query("select * from retailer where ID='$id'")->fetch_assoc();
...
.v-bal{
	...
	<div class="row">
		    ...
		    <div class="col-9 col-md-10">
		        <?php 
		        $news = $con->query("select * from news_alert where TYPE='RETAILER'")->fetch_assoc();
		        ?>
                    ...
                    <div class="navbar-container container-fluid">
                        <div>
                           ...
                           <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="img/<?php echo $retailer_row['IMAGE']; ?>" alt="User-Profile-Image">
