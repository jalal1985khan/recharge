...
if(isset($_GET['status'])){
   echo "<script>alert('Staus ".$_GET['status']." ".$_GET['op_id']."')</script>";
}
?>
                                                    ...
                                                    <table id="custm-tool-ele"
                                                     ...
                                                     <thead>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $date = date("Y-m-d");
                                                            $my_id = $_SESSION['rt_id'];
                                                            $q = $con->query("SELECT * FROM recharge_history where PERSON='RETAILER'and PERSON_ID='$my_id' and DATE='$date' order by ID DESC");
                                                            $i =1 ;
